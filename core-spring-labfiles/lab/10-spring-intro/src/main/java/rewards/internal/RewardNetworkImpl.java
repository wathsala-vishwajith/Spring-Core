...
public class RewardNetworkImpl implements RewardNetwork {
	...
	public RewardConfirmation rewardAccountFor(Dining dining) {
		...
		Account diningAccount =  accountRepository.findByCreditCard(dining.getCreditCardNumber());
		Restaurant restaurantMerchant = restaurantRepository.findByMerchantNumber(dining.getMerchantNumber());
		MonetaryAmount benefitAmount = restaurantMerchant.calculateBenefitFor(diningAccount,dining);
		AccountContribution accountContribution =  diningAccount.makeContribution(benefitAmount);
		diningAccount.updateBeneficiaries(diningAccount);
